...
public:
	...
	CDcmPic*	GetAPRImage(double dRotateMatrix[16], double dCenterX, double dCenterY, double dCenterZ, bool bMipDownSampling = FALSE);
...
private:
	inline void		ChangeCuttingPlane();
	void			SetCuttingPlane();
	inline void		ResetCuttingPlane();
...
private:
	...
	Vector3D*       m_pInitCuttingPlanePoint;
