...
extern "C" {
    ...
    VIZ_API void APR_GetCrosshairPosition(APRHandle handle, float* u, float* v);
    /// 获取旋转矩阵（列主序4x4，用于3D定位线变换）
    VIZ_API void APR_GetRotationMatrix(APRHandle handle, float* outMatrix16);
    /// ��ʾ/���ض�λ��
