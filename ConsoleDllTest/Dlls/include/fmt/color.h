...
class text_style {
  ...
  // ©°©¤©¤©´
  // ©¦ 0©¦©¤©´
  // ©¦..©¦ ©À©¤©¤ foreground color value
  // ©¦23©¦©¤©¼
  // ©À©¤©¤©È
  // ©¦24©¦©¤©Ð©¤©¤ discriminator for the above value. 00 if unset, 01 if it's
  ...
  // ©¦50©¦ ©¦
  // ©À©¤©¤©È ©¦
  // ©¦51©¦ ©À©¤©¤ background color (same format as the foreground color)
  // ©¦52©¦ ©¦
  // ©À©¤©¤©È ©¦
  // ©¦53©¦©¤©¼
  // ©À©¤©¤©È
  ...
  //    11 + 01 = 100 (!!)
  //    11 + 11 = 110 (!!)
  // In the last two cases, the ones we want to catch, the third bit¡ª¡ªthe
  // overflow bit¡ª¡ªis set. Bingo.
  //
